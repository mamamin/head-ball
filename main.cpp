...
void gamepage(SDL_Renderer *m_renderer)
{
    ...
    if (head_fire_ball_left && x_right-x_ball<=30 && y_ball>=y_right-90 && y_ball<=y_right+90)
    {
    ...
    if (head_fire_ball_right && x_ball-x_left<=60 && y_ball>=y_left-90 && y_ball<=y_left+90)
    {
